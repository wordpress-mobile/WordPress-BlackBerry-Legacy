...
public class PillButtonField extends BaseButtonField
{
    ...
    public static final int COLOUR_BORDER              = 0x464646;
    public static final int COLOUR_BORDER_FOCUS        = 0x464646;
    public static final int COLOUR_BORDER_SELECTED     = 0x464646;
    public static final int COLOUR_TEXT                = 0x464646;
    public static final int COLOUR_TEXT_FOCUS          = 0xFFFFFF;
    public static final int COLOUR_TEXT_SELECTED       = 0xFFFFFF;
    public static final int COLOUR_BACKGROUND          = 0xfbfafb;
    public static final int COLOUR_BACKGROUND_FOCUS    = 0x21759b;
    public static final int COLOUR_BACKGROUND_SELECTED = 0x21759b;
